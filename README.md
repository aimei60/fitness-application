...
- Neon, Fly.io, and Vercel were used to separate the database, backend, and frontend which gave me experience **managing multi-service deployments** and provides a foundation for improving scalability in the future.

## Live Demo

- View the Live site here: [**www.fitrequest.dev**](https://www.fitrequest.dev/)
- Try the Demo Account on the sign up/ login Page for a quick overview.
