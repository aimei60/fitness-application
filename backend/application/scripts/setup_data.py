...
with SessionLocal.begin() as session:
    ...
    sections = [
        workout_sections(SectionName="Beginner Warm Up", SectionOrder=1, Workout=beginner),
        workout_sections(SectionName="Beginner Circuit", SectionOrder=2, Workout=beginner),
        workout_sections(SectionName="Beginner Cool Down", SectionOrder=3, Workout=beginner),
        
        workout_sections(SectionName="Intermediate Warm Up", SectionOrder=1, Workout=intermediate),
        workout_sections(SectionName="Intermediate Circuit", SectionOrder=2, Workout=intermediate),
        workout_sections(SectionName="Intermediate Cool Down", SectionOrder=3, Workout=intermediate),
        
        workout_sections(SectionName="Advanced Warm Up", SectionOrder=1, Workout=advanced),
        workout_sections(SectionName="Advanced Circuit", SectionOrder=2, Workout=advanced),
        workout_sections(SectionName="Advanced Cool Down", SectionOrder=3, Workout=advanced),
        
        workout_sections(SectionName="Athlete Warm Up", SectionOrder=1, Workout=athlete),
        workout_sections(SectionName="Athlete Circuit", SectionOrder=2, Workout=athlete),
        workout_sections(SectionName="Athlete Cool Down", SectionOrder=3, Workout=athlete),
        
        workout_sections(SectionName="Child Warm Up", SectionOrder=1, Workout=child),
        workout_sections(SectionName="Child Circuit", SectionOrder=2, Workout=child),
        workout_sections(SectionName="Child Cool Down", SectionOrder=3, Workout=child),
        
        workout_sections(SectionName="Young Adult Warm Up", SectionOrder=1, Workout=young_adult),
        workout_sections(SectionName="Young Adult Circuit", SectionOrder=2, Workout=young_adult),
        workout_sections(SectionName="Young Adult Cool Down", SectionOrder=3, Workout=young_adult),
        
        workout_sections(SectionName="Midlife Warm Up", SectionOrder=1, Workout=midlife),
        workout_sections(SectionName="Midlife Circuit", SectionOrder=2, Workout=midlife),
        workout_sections(SectionName="Midlife Cool Down", SectionOrder=3, Workout=midlife),
        
        workout_sections(SectionName="Senior Warm Up", SectionOrder=1, Workout=senior),
        workout_sections(SectionName="Senior Circuit", SectionOrder=2, Workout=senior),
        workout_sections(SectionName="Senior Cool Down", SectionOrder=3, Workout=senior),
        
        workout_sections(SectionName="Recovery rehabilitation Warm Up", SectionOrder=1, Workout=recovery_rehabilitation),
        workout_sections(SectionName="Recovery rehabilitation Circuit", SectionOrder=2, Workout=recovery_rehabilitation),
        workout_sections(SectionName="Recovery rehabilitation Cool Down", SectionOrder=3, Workout=recovery_rehabilitation),
        
        workout_sections(SectionName="Chronic condition Warm Up", SectionOrder=1, Workout=chronic_condition),
        workout_sections(SectionName="Chronic condition Circuit", SectionOrder=2, Workout=chronic_condition),
        workout_sections(SectionName="Chronic condition Cool Down", SectionOrder=3, Workout=chronic_condition),
        
        workout_sections(SectionName="Post Partum Warm Up", SectionOrder=1, Workout=post_partum),
        workout_sections(SectionName="Post Partum Circuit", SectionOrder=2, Workout=post_partum),
        workout_sections(SectionName="Post Partum Cool Down", SectionOrder=3, Workout=post_partum),
        
        workout_sections(SectionName="Antenatal Warm Up", SectionOrder=1, Workout=antenatal),
        workout_sections(SectionName="Antenatal Circuit", SectionOrder=2, Workout=antenatal),
        workout_sections(SectionName="Antenatal Cool Down", SectionOrder=3, Workout=antenatal),
        
        workout_sections(SectionName="Sustainable Weight Care Warm Up", SectionOrder=1, Workout=sustainable_weight_care),
        workout_sections(SectionName="Sustainable Weight Care Circuit", SectionOrder=2, Workout=sustainable_weight_care),
        workout_sections(SectionName="Sustainable Weight Care Cool Down", SectionOrder=3, Workout=sustainable_weight_care),
        
        workout_sections(SectionName="Accessible fitness Warm Up", SectionOrder=1, Workout=accessible_fitness),
        workout_sections(SectionName="Accessible fitness Circuit", SectionOrder=2, Workout=accessible_fitness),
        workout_sections(SectionName="Accessible fitness Cool Down", SectionOrder=3, Workout=accessible_fitness),
        
        workout_sections(SectionName="Time constrained Warm Up", SectionOrder=1, Workout=time_constrained),
        workout_sections(SectionName="Time constrained Circuit", SectionOrder=2, Workout=time_constrained),
        workout_sections(SectionName="Time constrained Cool Down", SectionOrder=3, Workout=time_constrained),
        
        workout_sections(SectionName="Home based Warm Up", SectionOrder=1, Workout=home_based),
        workout_sections(SectionName="Home based Circuit", SectionOrder=2, Workout=home_based),
        workout_sections(SectionName="Home based Cool Down", SectionOrder=3, Workout=home_based),
        
        workout_sections(SectionName="Minimal Equipment Warm Up", SectionOrder=1, Workout=minimal_equipment),
        workout_sections(SectionName="Minimal Equipment Circuit", SectionOrder=2, Workout=minimal_equipment),
        workout_sections(SectionName="Minimal Equipment Cool Down", SectionOrder=3, Workout=minimal_equipment),
        
        workout_sections(SectionName="Outdoor Training Warm Up", SectionOrder=1, Workout=outdoor),
        workout_sections(SectionName="Outdoor Training Circuit", SectionOrder=2, Workout=outdoor),
        workout_sections(SectionName="Outdoor Training Cool Down", SectionOrder=3, Workout=outdoor),
        
        workout_sections(SectionName="Gym Equipment Warm Up", SectionOrder=1, Workout=gym_equipment),
        workout_sections(SectionName="Gym Equipment Circuit", SectionOrder=2, Workout=gym_equipment),
        workout_sections(SectionName="Gym Equipment Cool Down", SectionOrder=3, Workout=gym_equipment),
        
        workout_sections(SectionName="Weightloss Warm Up", SectionOrder=1, Workout=weightloss),
        workout_sections(SectionName="Weightloss Circuit", SectionOrder=2, Workout=weightloss),
        workout_sections(SectionName="Weightloss Cool Down", SectionOrder=3, Workout=weightloss),
        
        workout_sections(SectionName="Endurance Warm Up", SectionOrder=1, Workout=endurance),
        workout_sections(SectionName="Endurance Circuit", SectionOrder=2, Workout=endurance),
        workout_sections(SectionName="Endurance Cool Down", SectionOrder=3, Workout=endurance),
        
        workout_sections(SectionName="Flexibility and Mobility Warm Up", SectionOrder=1, Workout=flexibility_mobility),
        workout_sections(SectionName="Flexibility and Mobility Circuit", SectionOrder=2, Workout=flexibility_mobility),
        workout_sections(SectionName="Flexibility and Mobility Cool Down", SectionOrder=3, Workout=flexibility_mobility),
        
        workout_sections(SectionName="Everyday Movement Warm Up", SectionOrder=1, Workout=everyday_movement),
        workout_sections(SectionName="Everyday Movement Circuit", SectionOrder=2, Workout=everyday_movement),
        workout_sections(SectionName="Everyday Movement Cool Down", SectionOrder=3, Workout=everyday_movement),
        
        workout_sections(SectionName="Reducing Fall Warm Up", SectionOrder=1, Workout=reducing_fall_risk),
        workout_sections(SectionName="Reducing Fall Circuit", SectionOrder=2, Workout=reducing_fall_risk),
        workout_sections(SectionName="Reducing Fall Cool Down", SectionOrder=3, Workout=reducing_fall_risk),
        
        workout_sections(SectionName="Power Training Warm Up", SectionOrder=1, Workout=power_training),
        workout_sections(SectionName="Power Training Circuit", SectionOrder=2, Workout=power_training),
        workout_sections(SectionName="Power Training Cool Down", SectionOrder=3, Workout=power_training),
        
        workout_sections(SectionName="HIIT Warm Up", SectionOrder=1, Workout=hiit),
        workout_sections(SectionName="HIIT Circuit", SectionOrder=2, Workout=hiit),
        workout_sections(SectionName="HIIT Cool Down", SectionOrder=3, Workout=hiit),
        
        workout_sections(SectionName="Mind and Body Warm Up", SectionOrder=1, Workout=mind_and_body),
        workout_sections(SectionName="Mind and Body Circuit", SectionOrder=2, Workout=mind_and_body),
        workout_sections(SectionName="Mind and Body Cool Down", SectionOrder=3, Workout=mind_and_body),
        
        workout_sections(SectionName="Agility Warm Up", SectionOrder=1, Workout=agility),
        workout_sections(SectionName="Agility Circuit", SectionOrder=2, Workout=agility),
        workout_sections(SectionName="Agility Cool Down", SectionOrder=3, Workout=agility),
        
        workout_sections(SectionName="Isometric Training Warm Up", SectionOrder=1, Workout=isometric),
        workout_sections(SectionName="Isometric Training Circuit", SectionOrder=2, Workout=isometric),
        workout_sections(SectionName="Isometric Training Cool Down", SectionOrder=3, Workout=isometric),
        
        workout_sections(SectionName="Strength Training Warm Up", SectionOrder=1, Workout=strength),
        workout_sections(SectionName="Strength Training Circuit", SectionOrder=2, Workout=strength),
        workout_sections(SectionName="Strength Training Cool Down", SectionOrder=3, Workout=strength),
    ]
