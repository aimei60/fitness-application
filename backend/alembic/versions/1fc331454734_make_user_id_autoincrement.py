...
Revision ID: 1fc331454734
Revises: 94d58650caed
Create Date: 2025-07-07 17:38:19.455992
...
revision: str = '1fc331454734'
down_revision: Union[str, None] = '94d58650caed'
...
def downgrade() -> None:
    ...
    sa.Column('ID', sa.INTEGER(), server_default=sa.text('nextval(\'"Workout_Sections_ID_seq"\'::regclass)'), autoincrement=True, nullable=False),
